...
public class GeneratedTrainingCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String VEHICLEDEALERS = "VehicleDealers".intern();
		public static final String VEHICLEDRIVERS = "VehicleDrivers".intern();
		public static final String VEHICLELIST = "VehicleList".intern();
	}
	...
	{
		public static final String VEHICLEDRIVERS2VEHICLEDEALERS = "VehicleDrivers2VehicleDealers".intern();
		public static final String VEHICLEDRIVERS2VEHICLELIST = "VehicleDrivers2VehicleList".intern();
		public static final String VEHICLELIST2VEHICLEDEALERS = "VehicleList2VehicleDealers".intern();
	}
